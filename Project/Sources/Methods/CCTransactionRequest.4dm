//%attributes = {}
//9/16/17 - adding in case losing this info
...
Else 
	//9/16/17 added this to get rid of xml errors
	$vString:=$vString+"<TransactionID>"+"none"+"</TransactionID>"
End if 
$vString:=$vString+"</objparameters>"
...
If (OK=1)
	...
	//MessageBox ("";"Line 92 - First Child";"OKBox";"red")
