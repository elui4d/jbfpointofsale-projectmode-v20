...
$err.login:=FTP_Login("kansas.franconnect.net"; "jbfPOS"; "qa5evipujufo"; vFTP_ID; vFTP_Msg)
$err.send:=FTP_Send(vFTP_ID; vFinancialFile2; "")
...
//: (FTP_Login("kansas.franconnect.net"; "jbfPOS"; "qa5evipujufo"; vFTP_ID; vFTP_Msg)#0)
////(FTP_Login ("209.133.73.150";"jbfPOS";"qa5evipujufo";vFTP_ID;vFTP_Msg)#0)
////: (FTP_Login ("23.29.54.4";"jbfsftp";"jb7s7tp!@#";vFTP_ID;vFTP_Msg)#0)

//: (FTP_Progress(-1; -1; "JBF Point of Sale"; "Sending Customer Module…"; "*")#0)
