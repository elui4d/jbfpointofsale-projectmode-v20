...
If (OK=1)
	...
	//vLine1:="REM  Loading Credit Card App....................."+Char(13)+Char(10)
	//SEND PACKET(vhDoc;vLine1)
	//vLine2:="echo off"+Char(13)+Char(10)
	//SEND PACKET(vhDoc;vLine2)
	vLine3:=vePNJPOS_Path+" com.ePN.ePNJPOS.entryPoints.ePNJPOS2CmdLine -u "+vePNJPOS_Clerk+" -amount "+String:C10(vCCAmount)+" -p "+vePNJPOS_Password+Char:C90(13)
