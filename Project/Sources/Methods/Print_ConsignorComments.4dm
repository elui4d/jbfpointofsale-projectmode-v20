...
QUERY SELECTION:C341([Consignors:1]; [Consignors:1]Comment:24#"")
...
If (Records in selection:C76([Consignors:1])>0)
	...
	If (ok=1)
		vReportTitle:="Consignor Comments"
		...
		For ($vlRecord; 1; Records in selection:C76([Consignors:1]))
			...
			Print form:C5([Consignors:1]; "Print_ConsignorComments"; 0)
...
Else 
	...
	MessageBox(""; "You don't have any consignor comments in your database."; "OKBox"; "red")
End if 