Case of 
	...
	: (Form event code:C388=On Getting Focus:K2:7)
		OBJECT SET RGB COLORS:C628([Sales:2]Barcode:9; UTIL_4DColorToHex(Black:K11:16); UTIL_4DColorToHex(66))
		//OBJECT SET RGB COLORS([Sales]Barcode; "Black"; "Yellow")
		
	: (Form event code:C388=On Losing Focus:K2:8)
		OBJECT SET RGB COLORS:C628([Sales:2]Barcode:9; UTIL_4DColorToHex(Black:K11:16); UTIL_4DColorToHex(White:K11:1))
