If (ok=1)
	...
	$vString:=$vString+"<CCNumber>"+vCCNumber+"</CCNumber>"+Char:C90(13)
	$vString:=$vString+"<CCExpDate>"+vCCExpiration+"</CCExpDate>"+Char:C90(13)
	...
	//$vString:=$vString+"<MagData>"+vCCSwipe+"</MagData>"+Char(13)
