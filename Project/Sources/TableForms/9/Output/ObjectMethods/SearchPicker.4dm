...
Case of 
	...
	: (Form event code:C388=On Losing Focus:K2:8)
		If (vSearch#"")
			QUERY:C277([Volunteers:9]; [Volunteers:9]Consignor Number:1="@"+vSearch+"@"; *)
			QUERY:C277([Volunteers:9];  | ; [Volunteers:9]First Name:2="@"+vSearch+"@"; *)
			QUERY:C277([Volunteers:9];  | ; [Volunteers:9]Last Name:3="@"+vSearch+"@")
		End if 
		Toolbar_Setup
End case 
